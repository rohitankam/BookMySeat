...
public class SeatLayout extends AppCompatActivity {
    ...
    private final int NUMBER_OF_SEATS_LEFT_UPPER = 6;
    private final int NUMBER_OF_SEATS_RIGHT_UPPER = 5;
    private final int NUMBER_OF_ROWS_LEFT_UPPER = 3;
    private final int NUMBER_OF_ROWS_RIGHT_UPPER = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
                ...
                rightRowSeat.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                "seat # " + rightRowSeat.getSeatNumber(), Toast.LENGTH_SHORT)
                                .show();
            ...
            for (int rowCount = 0; rowCount <= nuumberOfSeatsInRow; rowCount++) {
                ...
                leftRowSeat.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                "seat # " + leftRowSeat.getSeatNumber(), Toast.LENGTH_SHORT)
                                .show();
                    }
                });
    ...
    public void Signup(View view) {
        ...
        startActivity(new Intent(SeatLayout.this,Payment.class));
        finish();
    }
}
